...
function centos6(){
	...
	wget -q http://progeny.sakura.ad.jp/siteguard/4.0.0/apache/siteguard-server-edition-4.00-3.apache.x86_64.rpm -P /root/.sakuracloud
	rpm -Uvh /root/.sakuracloud/siteguard-server-edition-4.00-3.apache.x86_64.rpm
