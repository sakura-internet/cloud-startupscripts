...
function centos6(){
	...
	wget -q http://progeny.sakura.ad.jp/siteguard/3.4.0/apache/siteguardlite-3.40-1.apache.x86_64.rpm -P /root/.sakuracloud
	rpm -Uvh /root/.sakuracloud/siteguardlite-3.40-1.apache.x86_64.rpm
